...
You can now keep your SQLite database up-to-date with your RestfulX model changes. Simply set @Rx.airEnableDatabaseMigrations = true@ in
your initialization function and RestfulX will add any new properties you add your model files as columns to your underlying SQLite database.
